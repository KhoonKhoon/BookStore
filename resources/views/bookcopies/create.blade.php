...
<div class="card m-4">
    ...
    <div class="card-body">
        <form action="{{ route('bookcopy.store') }}" method="post" class="form-control m-3">
            @csrf
                <div class="row m-5">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                        <select name="book_id" id="book" class="form-select" value="{{ old('book_id') }}">
                            <option value="#" default>Please select book</option>
